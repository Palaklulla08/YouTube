...
export const serverUrl = "https://youtube-oodn.onrender.com"
...
function App() {
  ...
  return (
    <>
     ...
     <Route path='/ytstudio' element={<ProtectedRoute userData={userData}><YTStudio /></ProtectedRoute>} >
   <Route path='/ytstudio/dashboard' element={<ProtectedRoute userData={userData}><Dashboard/></ProtectedRoute>} />
   <Route path='/ytstudio/content' element={<ProtectedRoute userData={userData}><ContentPage/></ProtectedRoute>} />
   <Route path='/ytstudio/analytics' element={<ProtectedRoute userData={userData}><AnalyticsPage/></ProtectedRoute>} />
   <Route path='/ytstudio/revenue' element={<ProtectedRoute userData={userData}><RevenuePage/></ProtectedRoute>} />
   <Route path='/ytstudio/managevideo/:videoId' element={<ProtectedRoute userData={userData}><ManageVideo/></ProtectedRoute>} />
   <Route path='/ytstudio/manageshort/:shortId' element={<ProtectedRoute userData={userData}><ManageShort/></ProtectedRoute>} />
   <Route path='/ytstudio/manageplaylist/:playlistId' element={<ProtectedRoute userData={userData}><ManagePlaylist/></ProtectedRoute>} />
    </Route>
